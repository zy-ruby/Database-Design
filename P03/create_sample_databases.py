...
def createDatabase1(name):
	...
	empty_schema = []
	empty = db.newRelation("empty", empty_schema)
	...
	instructor.insertTuple(Tuple(instr_schema, ('22228', 'Ejadd', 'Google', '80000')));
	instructor.insertTuple(Tuple(instr_schema, ('22228', 'Ejadd', 'Elec. Eng.', '80000')));
	...
	department.insertTuple(Tuple(dept_schema, ('XXX', 'Watson', '70000')));
	department.insertTuple(Tuple(dept_schema, ('XXX', 'Watson', '70000')));
	department.insertTuple(Tuple(dept_schema, ('YYY', 'Watson', '70000')));
	department.insertTuple(Tuple(dept_schema, ('EEE', 'Watson', '70000')));
	department.insertTuple(Tuple(dept_schema, ('EEE', 'Watson', '70000')));
	...
	instructor2.insertTuple(Tuple(instr_schema, ('22228', 'Ejadd', 'Elec. Eng.', '80000')));
