...
deleteFromTree(R, index, '32')
deleteFromTree(R, index, '33')
deleteFromTree(R, index, '34')
deleteFromTree(R, index, '35')
index.printTree()
deleteFromTree(R, index, '0')
deleteFromTree(R, index, '1')
deleteFromTree(R, index, '10')
index.printTree()
deleteFromTree(R, index, '11')
index.printTree()
deleteFromTree(R, index, '12')
checkValidityTree(index)
index.printTree()
